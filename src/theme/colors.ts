...
> = {
  ...
  OAU: {
    ...
    dark: {
      ...
      glowBlobAccent: 'rgba(96,165,250,0.10)',
    },
  },
  GLOBAL: {
    light: {
...
export const ACCENT_PRESETS: AccentPreset[] = [
  ...
  {
    id: 'ROSE',
    label: 'Coral Rose & Violet',
    campusName: 'Campus Vibrant',
    primaryLight: '#BE123C',
    primaryDark: '#FB7185',
    accentLight: '#7C3AED',
    accentDark: '#C084FC',
  ...
  {
    id: 'INDIGO',
    label: 'Midnight Indigo & Amber',
    campusName: 'Deep Academic',
    primaryLight: '#4338CA',
    primaryDark: '#818CF8',
    accentLight: '#F59E0B',
    accentDark: '#FBBF24',
