...
const palette = {
  ...
  skyWhiteBg: '#F1F6FB', // overall screen background
  waitlistOrange: '#F08A2E', // "Join Waitlist" button

  // Deep-teal rebrand palette (UniHub-inspired, per explicit design
  // request) — deliberately supersedes navy* as the active brand color
  // below. navy* tokens are kept, not deleted, in case of a future
  // revert; see the file-level comment for the full history.
  tealPrimary: '#0E5D4C', // main brand — buttons, active tab, headers
  tealPressed: '#0A4438', // pressed/darker state
  tealDeep: '#0C4A3D', // section-label text
  tealPaleBg: '#E1F2ED', // info-card backgrounds
  tealGlowRgb: '14,93,76', // RGB triplet of tealPrimary, for rgba() glow blobs
...
export const darkColors: ThemeColors = {
  background: palette.deepNavyBg,
  surface: '#111C32',
  // frostedCard dark: vertical gradient 92% slate-900 -> 96% deep navy
  glassSurfaceTop: 'rgba(15,23,42,0.92)',
  glassSurfaceBottom: 'rgba(10,19,38,0.96)',
  glassBorderStart: 'rgba(255,255,255,0.10)',
  glassBorderEnd: 'rgba(255,255,255,0.05)',
  glassShadowColor: 'rgba(0,0,0,0.35)',

  textPrimary: palette.textLight,
  textSecondary: palette.liorisNeutralGray,
  textInverse: palette.liorisDarkBg,

  brandPrimary: '#3D9A82',
  brandPrimaryPressed: palette.tealPrimary,
  brandAccent: palette.waitlistOrange,
  brandAccentPressed: '#D97517',
  brandSky: palette.liorisSky,
  brandMagenta: palette.liorisMagenta,
  sectionLabel: '#7FCBB5',
  pastelPrimaryBg: `rgba(${palette.tealGlowRgb},0.28)`,
  sageBg: 'rgba(27,122,75,0.18)',
  sageText: '#6EE7B7',
  roseBg: 'rgba(155,44,59,0.2)',
  roseText: '#FCA5A5',
  mintBg: 'rgba(15,118,110,0.2)',
  mintText: '#5EEAD4',
  lavenderBg: 'rgba(109,93,174,0.22)',
  lavenderText: '#D8B4FE',
  ...
  tabInactive: '#4B5568',
  tabActive: '#3D9A82',
  tabActivePillBg: `rgba(${palette.tealGlowRgb},0.3)`,

  glowBlobPrimary: `rgba(${palette.tealGlowRgb},0.3)`,
  glowBlobAccent: 'rgba(240,138,46,0.12)',
} as const;
