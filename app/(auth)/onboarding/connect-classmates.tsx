...
export default function ConnectClassmatesScreen() {
  ...
  return (
    <OnboardingShell
      currentPath="/(auth)/onboarding/connect-classmates"
      title={user?.role === 'alumni' ? 'Connect with classmates' : 'Connect with peers and alumni'}
      subtitle="A few suggested people to get your network started. You can always connect with more later."
