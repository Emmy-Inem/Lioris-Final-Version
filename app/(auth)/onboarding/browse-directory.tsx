...
export default function BrowseDirectoryScreen() {
  ...
  return (
    <OnboardingShell
      currentPath="/(auth)/onboarding/browse-directory"
      title="Meet fellow alumni"
      subtitle="Here's a preview of the alumni directory — you can search the full directory anytime."
      footer={<AppButton label="Continue" onPress={advance} fullWidth />}
    >
